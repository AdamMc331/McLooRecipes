...
import com.mcloo.recipes.shared.di.DependencyContainer
                ...
                Route.RecipeList -> {
                    NavEntry(key) {
                        RecipeListScreen(
                            viewModel = viewModel {
                                RecipeListViewModel(
                                    repository = DependencyContainer.recipeRepository,
                                )
                            },
                            navigateToAddRecipe = {
                ...
                Route.AddRecipe -> {
                    NavEntry(key) {
                        AddRecipeScreen(
                            viewModel = viewModel {
                                AddRecipeViewModel(
                                    recipeRepository = DependencyContainer.recipeRepository,
                                )
                            },
                            onComplete = {
